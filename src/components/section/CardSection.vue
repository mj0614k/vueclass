    ...
    <div class="card__inner" :class="layout">
      <article class="card">
        ...
        <div class="card__body">
          ...
          <p class="desc">
            돌고래가 그렇게 영악한 동물이라고 하죠. 근데 사실 그 커다란 바닷속에
            멍청한 물고기들 사이에서 저만 똑똑한 돌고래라면 저라도 다른
            물고기들을 장난감으로 생각할 것 같습니다. 지가 바다의 왕이야 뭐야...
            좋은 동물인지 나쁜 동물인지 헷갈리네요.
          </p>
          <a class="brn" href="/"> 더보기 </a>
        </div>
      </article>
      <article class="card">
        <figure class="card__header">
        ...
        <div class="card__body">
          ...
          <p class="desc">
            라쿤인지 너구리인지 구별 방법은 있다지만 굳이 따지고 싶지는 않네요.
            라쿤의 매력포인트는 역시 발바닥이죠. 라쿤 카페에서 악수하다가 팔찌를
            빼앗겼던 안 좋은 기억이 떠오르네요. 저는 팔찌를 끼면 안 되나 봅니다.
          </p>
          <a class="brn" href="/"> 더보기 </a>
        </div>
      </article>
      <article class="card">
        ...
        <div class="card__body">
          ...
          <p class="desc">
            ...
            보고, 환장하던 순댓국을 몇 달째 끊고 있습니다. 제가 비위가 나쁜 편은
            아닌데 진짜... 궁금하시면, 아래 더보기를 클릭하시면 아무것도 안
            나옵니다.
          </p>
          <a class="brn" href="/"> 더보기 </a>
        </div>
